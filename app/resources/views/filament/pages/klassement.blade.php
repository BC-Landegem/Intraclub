                    ...
                    <tbody>
                        @forelse ($ranking['categories'][$category] as $entry)
                            <tr style="border-top: 1px solid rgb(128 128 128 / 0.15);">
                                ...
                                <td style="padding: 0.375rem 0.5rem 0.375rem 0; text-align: right; font-variant-numeric: tabular-nums;">{{ $entry['average'] === null ? 'Niet actief' : number_format($entry['average'], 2, ',', '') }}</td>
